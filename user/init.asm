...
main(void)
{
  ...
  12:	88250513          	add	a0,a0,-1918 # 890 <malloc+0xea>
  ...
  3a:	86290913          	add	s2,s2,-1950 # 898 <malloc+0xf2>
  3e:	854a                	mv	a0,s2
  ...
  6e:	87e50513          	add	a0,a0,-1922 # 8e8 <malloc+0x142>
  ...
  8c:	80850513          	add	a0,a0,-2040 # 890 <malloc+0xea>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00000517          	auipc	a0,0x0
  9e:	7f650513          	add	a0,a0,2038 # 890 <malloc+0xea>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	80450513          	add	a0,a0,-2044 # 8b0 <malloc+0x10a>
  ...
  d2:	7fa50513          	add	a0,a0,2042 # 8c8 <malloc+0x122>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00000517          	auipc	a0,0x0
  e2:	7f250513          	add	a0,a0,2034 # 8d0 <malloc+0x12a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46e:	4fe50513          	add	a0,a0,1278 # 968 <digits>
 472:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 572:	3a270713          	add	a4,a4,930 # 910 <malloc+0x16a>
 ...
 5fc:	370b8b93          	add	s7,s7,880 # 968 <digits>
 ...
 650:	2bc90913          	add	s2,s2,700 # 908 <malloc+0x162>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7f6:	81e90913          	add	s2,s2,-2018 # 1010 <freep>
  if(p == (char*)-1)
 7fa:	5afd                	li	s5,-1
