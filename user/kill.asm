...
main(int argc, char **argv)
{
  ...
  4c:	7b858593          	add	a1,a1,1976 # 800 <malloc+0xee>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	4a250513          	add	a0,a0,1186 # 878 <digits>
 3de:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4de:	34670713          	add	a4,a4,838 # 820 <malloc+0x10e>
 ...
 568:	314b8b93          	add	s7,s7,788 # 878 <digits>
 ...
 5bc:	26090913          	add	s2,s2,608 # 818 <malloc+0x106>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 762:	8a290913          	add	s2,s2,-1886 # 1000 <freep>
  if(p == (char*)-1)
 766:	5afd                	li	s5,-1
