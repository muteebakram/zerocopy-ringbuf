...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	2a650513          	add	a0,a0,678 # 1340 <malloc+0xea>
      a2:	00001097          	auipc	ra,0x1
      a6:	df4080e7          	jalr	-524(ra) # e96 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	29650513          	add	a0,a0,662 # 1340 <malloc+0xea>
      b2:	00001097          	auipc	ra,0x1
      b6:	dec080e7          	jalr	-532(ra) # e9e <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	28c50513          	add	a0,a0,652 # 1348 <malloc+0xf2>
  ...
  chdir("/");
      ...
      da:	29250513          	add	a0,a0,658 # 1368 <malloc+0x112>
      de:	00001097          	auipc	ra,0x1
      e2:	dc0080e7          	jalr	-576(ra) # e9e <chdir>
      e6:	00001997          	auipc	s3,0x1
      ea:	29298993          	add	s3,s3,658 # 1378 <malloc+0x122>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	28098993          	add	s3,s3,640 # 1370 <malloc+0x11a>
  uint64 iters = 0;
      f8:	4481                	li	s1,0
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	52c90913          	add	s2,s2,1324 # 1628 <malloc+0x3d2>
    ...
    if(what == 1){
     ...
     10e:	27650513          	add	a0,a0,630 # 1380 <malloc+0x12a>
    ...
    if(what == 1){
     ...
     168:	22c50513          	add	a0,a0,556 # 1390 <malloc+0x13a>
     ...
     182:	20250513          	add	a0,a0,514 # 1380 <malloc+0x12a>
     ...
     194:	1b050513          	add	a0,a0,432 # 1340 <malloc+0xea>
     ...
     1a6:	20650513          	add	a0,a0,518 # 13a8 <malloc+0x152>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cd4080e7          	jalr	-812(ra) # e7e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	1b650513          	add	a0,a0,438 # 1368 <malloc+0x112>
     1ba:	00001097          	auipc	ra,0x1
     1be:	ce4080e7          	jalr	-796(ra) # e9e <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	18450513          	add	a0,a0,388 # 1348 <malloc+0xf2>
     ...
     1f0:	1c450513          	add	a0,a0,452 # 13b0 <malloc+0x15a>
     ...
     212:	1b250513          	add	a0,a0,434 # 13c0 <malloc+0x16a>
     ...
     256:	12e50513          	add	a0,a0,302 # 1380 <malloc+0x12a>
     25a:	00001097          	auipc	ra,0x1
     25e:	c3c080e7          	jalr	-964(ra) # e96 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	17250513          	add	a0,a0,370 # 13d8 <malloc+0x182>
     ...
     282:	16a50513          	add	a0,a0,362 # 13e8 <malloc+0x192>
     ...
     294:	16050513          	add	a0,a0,352 # 13f0 <malloc+0x19a>
     298:	00001097          	auipc	ra,0x1
     29c:	bfe080e7          	jalr	-1026(ra) # e96 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	15450513          	add	a0,a0,340 # 13f8 <malloc+0x1a2>
     ...
     2c0:	14c50513          	add	a0,a0,332 # 1408 <malloc+0x1b2>
     ...
     2d2:	10250513          	add	a0,a0,258 # 13d0 <malloc+0x17a>
     2d6:	00001097          	auipc	ra,0x1
     2da:	ba8080e7          	jalr	-1112(ra) # e7e <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	0ca58593          	add	a1,a1,202 # 13a8 <malloc+0x152>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	12a50513          	add	a0,a0,298 # 1410 <malloc+0x1ba>
     ...
     2fc:	13050513          	add	a0,a0,304 # 1428 <malloc+0x1d2>
     300:	00001097          	auipc	ra,0x1
     304:	b7e080e7          	jalr	-1154(ra) # e7e <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	0a858593          	add	a1,a1,168 # 13b0 <malloc+0x15a>
     310:	00001517          	auipc	a0,0x1
     314:	12850513          	add	a0,a0,296 # 1438 <malloc+0x1e2>
     ...
     348:	0fc50513          	add	a0,a0,252 # 1440 <malloc+0x1ea>
     ...
     396:	0ae50513          	add	a0,a0,174 # 1440 <malloc+0x1ea>
     ...
     3f6:	06650513          	add	a0,a0,102 # 1458 <malloc+0x202>
     ...
     422:	00250513          	add	a0,a0,2 # 1420 <malloc+0x1ca>
     ...
     45e:	00e50513          	add	a0,a0,14 # 1468 <malloc+0x212>
     ...
     4ac:	f9850513          	add	a0,a0,-104 # 1440 <malloc+0x1ea>
     ...
     508:	f7c50513          	add	a0,a0,-132 # 1480 <malloc+0x22a>
     ...
     534:	f6858593          	add	a1,a1,-152 # 1498 <malloc+0x242>
     ...
     636:	e0e50513          	add	a0,a0,-498 # 1440 <malloc+0x1ea>
     ...
     650:	e9450513          	add	a0,a0,-364 # 14e0 <malloc+0x28a>
     ...
     664:	e8050513          	add	a0,a0,-384 # 14e0 <malloc+0x28a>
     ...
     67c:	e2058593          	add	a1,a1,-480 # 1498 <malloc+0x242>
     ...
     6c2:	e2250513          	add	a0,a0,-478 # 14e0 <malloc+0x28a>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	7b8080e7          	jalr	1976(ra) # e7e <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	e1850513          	add	a0,a0,-488 # 14e8 <malloc+0x292>
     ...
     6ee:	e1650513          	add	a0,a0,-490 # 1500 <malloc+0x2aa>
     ...
     708:	e1450513          	add	a0,a0,-492 # 1518 <malloc+0x2c2>
     ...
     724:	e1050513          	add	a0,a0,-496 # 1530 <malloc+0x2da>
     ...
     73e:	e1e50513          	add	a0,a0,-482 # 1558 <malloc+0x302>
     ...
     826:	dd658593          	add	a1,a1,-554 # 15f8 <malloc+0x3a2>
     ...
     84a:	dba50513          	add	a0,a0,-582 # 1600 <malloc+0x3aa>
     ...
     864:	c2058593          	add	a1,a1,-992 # 1480 <malloc+0x22a>
     868:	4509                	li	a0,2
     ...
     880:	c0458593          	add	a1,a1,-1020 # 1480 <malloc+0x22a>
     884:	4509                	li	a0,2
     ...
     8dc:	ca858593          	add	a1,a1,-856 # 1580 <malloc+0x32a>
     8e0:	4509                	li	a0,2
     ...
     950:	af458593          	add	a1,a1,-1292 # 1440 <malloc+0x1ea>
     954:	4509                	li	a0,2
     ...
     99c:	be858593          	add	a1,a1,-1048 # 1580 <malloc+0x32a>
     9a0:	4509                	li	a0,2
     ...
     9e0:	ba458593          	add	a1,a1,-1116 # 1580 <malloc+0x32a>
     9e4:	4509                	li	a0,2
     ...
     a48:	9fc58593          	add	a1,a1,-1540 # 1440 <malloc+0x1ea>
     a4c:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	9b450513          	add	a0,a0,-1612 # 1420 <malloc+0x1ca>
     a74:	00000097          	auipc	ra,0x0
     a78:	40a080e7          	jalr	1034(ra) # e7e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	95450513          	add	a0,a0,-1708 # 13d0 <malloc+0x17a>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	98a50513          	add	a0,a0,-1654 # 1440 <malloc+0x1ea>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b02:	94250513          	add	a0,a0,-1726 # 1440 <malloc+0x1ea>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f1e:	7ce50513          	add	a0,a0,1998 # 16e8 <digits>
     f22:	883a                	mv	a6,a4
     f24:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    10ac:	640b8b93          	add	s7,s7,1600 # 16e8 <digits>
    10b0:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10c4:	0992                	sll	s3,s3,0x4
    10c6:	397d                	addw	s2,s2,-1
    ...
    1100:	58c90913          	add	s2,s2,1420 # 1688 <malloc+0x432>
        while(*s != 0){
    1104:	02800593          	li	a1,40
    1108:	bff1                	j	10e4 <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    110a:	008b8913          	add	s2,s7,8
...
{
    119e:	711d                	add	sp,sp,-96
    11a0:	ec06                	sd	ra,24(sp)
    11a2:	e822                	sd	s0,16(sp)
    11a4:	1000                	add	s0,sp,32
...
free(void *ap)
{
    11d4:	1141                	add	sp,sp,-16
    11d6:	e422                	sd	s0,8(sp)
    11d8:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11da:	ff050693          	add	a3,a0,-16
    ...
    120a:	00e6ea63          	bltu	a3,a4,121e <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    1224:	02059813          	sll	a6,a1,0x20
    1228:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    1238:	02061593          	sll	a1,a2,0x20
    123c:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    ...
    1268:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    126a:	02051493          	sll	s1,a0,0x20
    126e:	9081                	srl	s1,s1,0x20
    1270:	04bd                	add	s1,s1,15
    1272:	8091                	srl	s1,s1,0x4
    1274:	0014899b          	addw	s3,s1,1
    1278:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12a6:	d6e90913          	add	s2,s2,-658 # 2010 <freep>
  if(p == (char*)-1)
    12aa:	5afd                	li	s5,-1
    12ac:	a895                	j	1320 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12ae:	00001797          	auipc	a5,0x1
    12b2:	15a78793          	add	a5,a5,346 # 2408 <base>
    ...
    12ce:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12d0:	02071693          	sll	a3,a4,0x20
    12d4:	01c6d713          	srl	a4,a3,0x1c
